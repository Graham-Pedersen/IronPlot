...
namespace IronPlot.IronRacketVSPackage
{
    ...
    /// </summary>
    [Guid(GuidList.guidIronRacketVSPackageEditorFactoryString)]
    public sealed class EditorFactory : IVsEditorFactory, IDisposable
    {
        private IronRacketVSPackagePackage editorPackage;
        private ServiceProvider vsServiceProvider;


        public EditorFactory(IronRacketVSPackagePackage package)
        {
                        ...
                        out int pgrfCDW)
        {
            ...
            pguidCmdUI = GuidList.guidIronRacketVSPackageEditorFactory;
            pgrfCDW = 0;
