...
using IronPlot.IronRacketVSPackage;

namespace IronRacketVSPackage_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new IronRacketVSPackagePackage() as IVsPackage;
            ...
            BaseMock registerEditor = IronRacketVSPackage_UnitTests.EditorTests.RegisterEditorsServiceMock.GetRegisterEditorsInstance();
            ...
            CommandID menuCommandID = new CommandID(IronPlot.IronRacketVSPackage.GuidList.guidIronRacketVSPackageCmdSet, (int)IronPlot.IronRacketVSPackage.PkgCmdIDList.cmdidREPL);
