...
namespace IronRacketVSPackage_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(IronPlot.IronRacketVSPackage.GuidList.guidIronRacketVSPackageCmdSet, (int)IronPlot.IronRacketVSPackage.PkgCmdIDList.cmdidREPL);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "IronRacketVSPackage", "IronPlot.IronRacketVSPackage.IronRacketVSPackagePackage");
