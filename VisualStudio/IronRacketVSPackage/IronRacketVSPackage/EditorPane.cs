...
namespace IronPlot.IronRacketVSPackage
{
    ...
    //     - An empty plot file in the same directory as NewFileItems.vsdir. In
    //       our case we chose MyExtFile.plot. Note this file name appears in Editor.vsdir
    ...
    //             be named as MyExtFile1.plot, MyExtFile2.plot... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    MyExtFile.plot|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - MyExtFile.plot - our empty plot file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".plot";
        ...
        #region Fields
        private IronRacketVSPackagePackage myPackage;
        ...
        public EditorPane(IronRacketVSPackagePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the plot document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(IronRacketVSPackagePackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidIronRacketVSPackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidIronRacketVSPackageCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidIronRacketVSPackageEditorFactory;
            return VSConstants.S_OK;
        }
