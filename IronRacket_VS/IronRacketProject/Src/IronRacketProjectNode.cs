...
namespace Microsoft.VisualStudio.Project.Samples.IronRacketProject
{
    ...
    public class IronRacketProjectNode : ProjectNode
    {
        ...
        #region Constructors
        /// <summary>
        /// Initializes the <see cref="IronRacketProjectNode"/> class.
        /// </summary>
        static IronRacketProjectNode()
        {
            imageList = Utilities.GetImageList(typeof(IronRacketProjectNode).Assembly.GetManifestResourceStream("Microsoft.VisualStudio.Project.Samples.CustomProject.Resources.plt48.png"));
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="IronRacketProjectNode"/> class.
        /// </summary>
        /// <param name="package">Value of the project package for initialize internal package field.</param>
        public IronRacketProjectNode(IronRacketProjectPackage package)
        {
        ...
        {
            get { return typeof(IronRacketProjectFactory).GUID; }
        }
        ...
        {
            IronRacketProjectFileNode node = new IronRacketProjectFileNode(this, item);
