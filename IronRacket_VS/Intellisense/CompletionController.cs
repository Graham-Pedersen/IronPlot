...
namespace IRLanguage
{
    ...
    internal sealed class CommandFilter : IOleCommandTarget
    {
        ...
        private void Filter()
        {
            ...
            string s = _currentSession.TextView.Caret.ContainingTextViewLine.Extent.GetText();
            FileState.IntelliSense_filterer.Filter_list(ref comp, s);
